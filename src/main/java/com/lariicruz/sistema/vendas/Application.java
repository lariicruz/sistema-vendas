package com.lariicruz.sistema.vendas;

import java.text.SimpleDateFormat;
import java.util.Arrays;

import com.lariicruz.sistema.vendas.domain.*;
...
import com.lariicruz.sistema.vendas.domain.enums.TipoCliente;
import com.lariicruz.sistema.vendas.repository.*;
...
public class Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "maria-silva@gmail.com", "06096832169", TipoCliente.PESSOAFISICA);

        cli1.getTelefones().addAll(Arrays.asList("34890717", "32613011"));
